import argparse
from hf_llc import run_llc_analysis
...
print(f"The LLC will be computed for: {part or 'FULL MODEL'}")


run_llc_analysis(args.model, part=part, output_suffix=output_suffix)